 ...
 * entry - the best price from (0,0) to this NodeData
 * numOfPaths - number of shortest paths until this NodeData
 * entryFromTheEnd - same as entry, but from the end to (0,0)
 */

public class BestPathGilLevy {
	int cheapestPrice, numOfPaths;
	private NodeData [][]mat;
	
	public BestPathGilLevy(NodeData[][] mat){
		this.mat = mat;
		cheapestPrice = 0;
		numOfPaths = 0;
		buildMatrix();
